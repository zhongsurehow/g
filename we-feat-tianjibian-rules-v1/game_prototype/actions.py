...
def get_valid_actions(game_state: GameState, player: Player, ap: int, mods: Modifiers, **flags) -> Dict[int, Dict[str, Any]]:
        ...
        if ap >= 1:  # Playing a card costs 1 AP
            for gua in card.associated_guas:
                actions[action_id] = {
                    ...
                    "cost": 1,
                    "description": f"Play {card.name} to {gua} ☯️",
                    "args": [i, gua]
                }
                action_id += 1
    ...
    if ap >= 1:
        actions[action_id] = {
            ...
            "cost": 1,
            "description": "Study (draw cards, gain wisdom) 📚",
            "args": []
        }
        action_id += 1
    ...
    actions[action_id] = {
        ...
        "cost": 0,
        "description": "View Wisdom Progress (查看智慧收集进度) 📜",
        "args": []
    }
    action_id += 1
    ...
    actions[action_id] = {
        ...
        "cost": 0,
        "description": "Learning Progress (学习进度) 📊",
        "args": []
    }
    action_id += 1
    ...
    actions[action_id] = {
        ...
        "cost": 0,
        "description": "Achievement List (成就列表) 🎯",
        "args": []
    }
    action_id += 1
    ...
    actions[action_id] = {
        ...
        "cost": 0,
        "description": "View Enhanced Cards (查看增强卡牌) 🃏",
        "args": []
    }
    action_id += 1
    ...
    if ap >= 1:
        actions[action_id] = {
            ...
            "cost": 1,
            "description": "Use Enhanced Card (使用增强卡牌) ✨",
            "args": []
        }
        action_id += 1
    ...
    if ap >= 1 and player.dao_xing >= 2:
        actions[action_id] = {
            ...
            "cost": 1,
            "description": "Consult Yijing (咨询易经) 📜",
            "args": []
        }
        action_id += 1
