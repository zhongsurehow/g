...
function updateTable() {
    ...
    filteredData.forEach(crypto => {
        ...
        row.innerHTML = `
            ...
            ${createPriceCell(crypto.binance, maxPrice, minPrice)}
            ${createPriceCell(crypto.okx, maxPrice, minPrice)}
            ${createPriceCell(crypto.mexc, maxPrice, minPrice)}
            ${createPriceCell(crypto.gate, maxPrice, minPrice)}
            ${createPriceCell(crypto.kucoin, maxPrice, minPrice)}
